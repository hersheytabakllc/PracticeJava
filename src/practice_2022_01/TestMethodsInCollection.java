...
public class TestMethodsInCollection {
    public static void main(String[] args) {
        ...
        set1.addAll(set2);
        System.out.println("\nAfter adding set2 to set1 is " + set1);
        
        set1.removeAll(set2);
        System.out.println("\nAfter removing set2 from set1 is " + set1);
        
        set1.retainAll(set2);
        System.out.println("After removing common elelments in set2 from set1, set1 is " + set1);
    }
}
